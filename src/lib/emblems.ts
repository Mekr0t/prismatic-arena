// emblems.ts â€” reading the trait out of a trait emblem.
//
...
// cannot be trusted for it â€” set 18 ships `DA_18_EmblemSlayer` named "Ravager
// Emblem", granting Ravager â€” and CDragon's `associatedTraits` field is empty
 ...
 *
 * Set 18's emblems publish NOTHING â€” `desc: null`, `effects: {}`, no
 * `associatedTraits` â€” so unlike the trait-grant line above, the bonus cannot be
 ...
 * better left out â€” the grant line alone is honest, a wrong effect is not.
 *
 ...
 *
 * Remaining set-18 emblems, for whoever fills these in â€” uncomment and complete
...
export const EMBLEM_BONUSES: Record<string, string> = {
  ...
  brawler: 'Attacks deal 2.5% of the holder\'s max Health as magic damage.',
  executioner: 'Damage executes enemies below 12% of their max Health.',
  vanguard: 'If the holder survives 20 seconds in player combat, gain 1 player health.',
  defender: 'Combat Start: Gain 6% Attack Speed for every ally that starts in the front row.',
  spellweaver: 'Gain 2 Mana whenever an ally casts their Ability.',
  rapidfire: 'Attacks deal 1% of the target\'s max Health as true damage.',
  juggernaut: 'Gain 15 Mana whenever a Juggernaut dies.',
  hunter: 'Takedowns grant 18% Attack Damage.',
  sprykin: 'If the holder is riding the BFF, gain an additional 30% Attack Speed, 20 Armor and 20 Magic Resist.',
  ravager: 'Gain 3% Damage Amp per 300 Health restored.',
};
 ...
 * `associatedTraits` â€” nothing â€” so the Library showed a named icon above an
